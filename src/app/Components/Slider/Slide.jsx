import { HoverSlider,
    ...
    TextStaggerHover } from "./animated-slideshow"
  ...
  export function HoverSliderDemo () {
      return (
          <HoverSlider className="min-h-svh place-content-center p-6 md:px-12 bg-[#0000] text-[#ffffff]">
        <h3 className="mb-5 mt-15  text-[#88734C] text-xl text-center font-bold uppercase tracking-wide text-[#ffffff]">
          services
        </h3>
        <h3 className="mb-20 text-[#88734C] text-4xl text-center font-bold uppercase tracking-wide ">
          our core services
        </h3>
          ...
          <div className="flex  flex-col space-y-2 md:space-y-4   ">
            {SLIDES.map((slide, index) => (
              <TextStaggerHover
                key={slide.title}
                index={index}
                className="cursor-pointer text-5xl font-bold uppercase tracking-tighter"
                text={slide.title}
              />
            ))}
          </div>
