  ...
  return (
    <section
      ...
      <motion.div
        ...
        <motion.p
          className="text-center max-w-2xl mx-auto mb-16 text-white/80"
  ...
  return (
    <motion.div
      ...
      <motion.div
        ...
        <h3
          className="text-xl font-medium text-white group-hover:text-[#88734C] transition-colors duration-300">
          {title}
        </h3>
      </motion.div>
      <motion.p
...
function StatCounter({
  ...
  return (
    <motion.div
      ...
      <motion.div
        className="w-10 h-0.5 bg-[#88734C] mt-3 group-hover:w-16 transition-all duration-300" />
    </motion.div>
  );
}
