    ...
    <div className="flex items-center justify-center min-h-screen bg-black">
      <div className="flex flex-1 flex-col justify-center px-4 py-10 lg:px-6 bg-black">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <Logo
            className="mx-auto h-10 w-10 text-white dark:text-foreground"
            aria-hidden={true} />
          <h3
            className="mt-2 text-center text-lg font-bold text-white dark:text-foreground">
            ...
            <form action="#" method="post" className="space-y-4">
              ...
              <div className="mt-2 flex items-start">
                <div className="flex h-6 items-center">
                  <Checkbox id="newsletter-login-05" name="newsletter-login-05" className="size-4" />
                </div>
                <Label
              ...
              <Button type="submit" className="mt-4 w-full py-2 font-medium bg-white text-black hover:bg-[#88734C] hover:text-white">
                Create account
              </Button>
              ...
              <p
                ...
                <a
                  href="#"
                  className="capitalize text-white hover:text-[#88734C]">
                  Terms of use
                </a>{" "}
                and{" "}
                <a
        ...
        <p
          ...
          <a
            href="#"
            className="font-medium text-white hover:text-[#88734C]">
            Sign in
          </a>
        </p>
      </div>
